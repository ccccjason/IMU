...
public class So3Util
{
    ...
    public static void sO3FromMu(Vector3d w, Matrix3x3d result)
    {
        ...
        if (thetaSq < 1.0E-8D) {
            ...
            kA = 1.0D - thetaSq * 0.1666666716337204D * (1.0D - 0.1666666716337204D *
                    thetaSq);
        } else {
        ...
        if (cosAngle > 0.7071067811865476D) {
            ...
            if (cosAngle > -0.7071067811865476D) {
                ...
                if (d0 * d0 > d1 * d1 && d0 * d0 > d2 * d2) {
                    r2.set(d0, (so3.get(1, 0) + so3.get(0, 1)) / 2.0D, (so3.get(0, 2) + so3.get(2,
                            0)) / 2.0D);
                } else if (d1 * d1 > d2 * d2) {
                    r2.set((so3.get(1, 0) + so3.get(0, 1)) / 2.0D, d1, (so3.get(2, 1) + so3.get(1,
                            2)) / 2.0D);
                } else {
                    r2.set((so3.get(0, 2) + so3.get(2, 0)) / 2.0D, (so3.get(2, 1) + so3.get(1,
                            2)) / 2.0D, d2);
                }
