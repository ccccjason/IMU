...
public class OrientationEKF
{
    ...
    private Matrix3x3d accObservationFunctionForNumericalJacobianTempM = new
    Matrix3x3d();
    private Matrix3x3d magObservationFunctionForNumericalJacobianTempM = new
    Matrix3x3d();
    ...
    public static void arrayAssign(double[][] data, Matrix3x3d m)
    {
        ...
        m.set(data[0][0], data[0][1], data[0][2], data[1][0], data[1][1], data[1][2],
    ...
    private void updateAccelCovariance(double currentAccelNorm)
    {
        ...
        this.movingAverageAccelNormChange = 0.5D * currentAccelNormChange + 0.5D *
                                            this.movingAverageAccelNormChange;
    ...
    public synchronized void processAcc(Vector3d acc, long sensorTimeStamp)
    {
        ...
        if (this.alignedToGravity) {
            this.accObservationFunctionForNumericalJacobian(this.so3SensorFromWorld,
                    this.mNu);
            double eps = 1.0E-7D;
            ...
            for (int dof = 0; dof < 3; ++dof) {
                ...
                this.accObservationFunctionForNumericalJacobian(this.processAccTempM2,
    ...
    public synchronized void processMag(float[] mag, long sensorTimeStamp)
    {
        ...
        if (this.alignedToGravity) {
            ...
            if (this.alignedToNorth) {
                this.magObservationFunctionForNumericalJacobian(this.so3SensorFromWorld,
                        this.mNu);
                double eps = 1.0E-7D;
                ...
                for (int dof = 0; dof < 3; ++dof) {
                    ...
                    this.magObservationFunctionForNumericalJacobian(this.processMagTempM2,
                            this.processMagTempV4);
    ...
    private double[] glMatrixFromSo3(Matrix3x3d so3)
    {
        ...
        this.rotationMatrix[3] = this.rotationMatrix[7] = this.rotationMatrix[11] =
                                     0.0D;
        this.rotationMatrix[12] = this.rotationMatrix[13] = this.rotationMatrix[14] =
                                      0.0D;
    ...
    private void filterGyroTimestep(float timeStep)
    {
        ...
        if (!this.timestepFilterInit) {
            ...
            this.filteredGyroTimestep = 0.95F * this.filteredGyroTimestep + 0.050000012F *
                                        timeStep;
    ...
    private void updateCovariancesAfterMotion()
    {
        ...
        Matrix3x3d.mult(this.so3LastMotion, this.updateCovariancesAfterMotionTempM2,
                        this.mP);
        this.so3LastMotion.setIdentity();
    }
