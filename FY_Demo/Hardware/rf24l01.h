...
#define RF_CS_PORT       GPIOC
#define RF_CS_PIN_SCK    RCC_AHBPeriph_GPIOC

#define RF_CE_PIN        GPIO_Pin_8
#define RF_CE_PORT       GPIOA
#define RF_CE_PIN_SCK    RCC_AHBPeriph_GPIOA

#define RF_IQR_PIN        GPIO_Pin_9
#define RF_IQR_PORT       GPIOC
#define RF_IQR_PIN_SCK    RCC_AHBPeriph_GPIOC
...
#define RF_MOSI_SOURCE    GPIO_PinSource15
#define RF_MOSI_AF        GPIO_AF_0


#define RF_SPI2               RCC_APB1Periph_SPI2
#define SPI_RF_CS_LOW()       GPIO_ResetBits(GPIOC, GPIO_Pin_8)
#define SPI_RF_CS_HIGH()      GPIO_SetBits(GPIOC, GPIO_Pin_8)
#define SPI_RF_CE_LOW()       GPIO_ResetBits(GPIOA, GPIO_Pin_8)
#define SPI_RF_CE_HIGH()      GPIO_SetBits(GPIOA, GPIO_Pin_8)
#define SPI_RF_IRQ()              GPIO_ReadInputDataBit ( GPIOC, GPIO_Pin_9) //中断引脚
