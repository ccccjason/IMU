...
int main()
{
    ...
    uint8_t whoami = mpu6050.readByte(MPU6050_ADDRESS,
    ...
    if (whoami == 0x68) { // WHO_AM_I should always be 0x68
        ...
        if (SelfTest[0] < 1.0f && SelfTest[1] < 1.0f && SelfTest[2] < 1.0f &&
            ...
            mpu6050.calibrateMPU6050(gyroBias,
    ...
    while (1) {
        ...
        if (mpu6050.readByte(MPU6050_ADDRESS,
            ...
            gx = (float)gyroCount[0] *
                 gRes; // - gyroBias[0];  // get actual gyro value, this depends on scale being set
        ...
        mpu6050.MadgwickQuaternionUpdate(ax, ay, az, gx * PI / 180.0f, gy * PI / 180.0f,
                                         gz * PI / 180.0f);
