...
public:
    ...
    void onFovDidChange(HeadMountedDisplay* hmd, FieldOfView* leftEyeFov,
                        FieldOfView* rightEyeFov, GLfloat virtualEyeToScreenDistance);
...
private:
    ...
    GLfloat computeDistortionScale(Distortion* distortion, GLfloat screenWidthM,
                                   GLfloat interpupillaryDistanceM);

    GLuint createTexture(GLint width, GLint height, GLint textureFormat,
                         GLint textureType);
