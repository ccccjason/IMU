...
class Cardboard : public UIScreenExt::OrientationObserver,
    public MagnetSensor::MagnetSensorObserver
{
public:
    Cardboard();
    virtual ~Cardboard();
    ...
    void update();
    bool areFrameParamentersReady()
    {
        return this->frameParamentersReady;
    }

    void OnOrientationChanged();
    void OnMagnetTrigger(MagnetSensor* sender);

    MagnetSensor* getMagnetSensor()
    {
    ...
    {
        return this->headMountedDisplay;
    }
    DistortionRenderer* getDistortionRenderer()
    {
...
private:
    ...
    static void UpdateUndistortedFOVAndViewport(Cardboard* cardboard, Eye* _leftEye,
            Eye* _rightEye);

    static void UpdateMonocularFov(Cardboard* cardboard,
                                   FieldOfView* _monocularFov);

    static void UpdateFovsWithLeftEyeFov(Cardboard* cardboard,
                                         FieldOfView* leftEyeFov, FieldOfView* rightEyeFov);
