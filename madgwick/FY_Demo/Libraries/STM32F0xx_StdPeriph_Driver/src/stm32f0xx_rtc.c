...
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
    ...
    if ((RTC_Format == RTC_Format_BIN) &&
        ...
        RTC_DateStruct->RTC_Month = (RTC_DateStruct->RTC_Month & (uint32_t)~
                                     (0x10)) + 0x0A;
    }
                  ...
                  RTC_AlarmTypeDef* RTC_AlarmStruct)
{
    ...
    if (RTC_Format == RTC_Format_BIN) {
        ...
        if ((RTC->CR & RTC_CR_FMT) != (uint32_t)RESET) {
            ...
            RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 = 0x00;
            assert_param(IS_RTC_HOUR24(RTC_Bcd2ToByte(
                                           RTC_AlarmStruct->RTC_AlarmTime.RTC_Hours)));
        }

        assert_param(IS_RTC_MINUTES(RTC_Bcd2ToByte(
                                        RTC_AlarmStruct->RTC_AlarmTime.RTC_Minutes)));
        assert_param(IS_RTC_SECONDS(RTC_Bcd2ToByte(
                              ...
                              uint32_t RTC_AlarmSubSecondValue, uint8_t RTC_AlarmSubSecondMask)
{
    ...
    tmpreg = (uint32_t)(((uint32_t)(RTC_AlarmSubSecondValue)) | ((uint32_t)(
                            RTC_AlarmSubSecondMask) << 24));
                                  ...
                                  uint32_t RTC_SmouthCalibMinusPulsesValue)
{
    ...
    if ((RTC->ISR & RTC_ISR_RECALPF) == RESET) {
        ...
        RTC->CAL = (uint32_t)((uint32_t)RTC_SmoothCalibPeriod |
                              (uint32_t)RTC_SmoothCalibPlusPulses | (uint32_t)
                      ...
                      RTC_DateTypeDef* RTC_StampDateStruct)
{
    ...
    RTC_StampTimeStruct->RTC_Hours = (uint8_t)((tmptime & (RTC_TR_HT | RTC_TR_HU))
                                     >> 16);
    ...
    RTC_StampDateStruct->RTC_Month = (uint8_t)((tmpdate & (RTC_DR_MT | RTC_DR_MU))
                                     >> 8);
