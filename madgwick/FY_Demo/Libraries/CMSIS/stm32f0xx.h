...
typedef struct {
    __IO uint32_t
    CSR;     /*!< COMP comparator control and status register, Address offset: 0x1C */
} COMP_TypeDef;
...
typedef struct {
    ...
    __IO uint32_t
    CAL;        /*!< RTC calibration register,                                 Address offset: 0x3C */
    __IO uint32_t
...
typedef struct {
    ...
    __IO uint32_t
    IOGXCR[6]; /*!< TSC I/O group x counter register,                         Address offset: 0x34-48 */
} TSC_TypeDef;
